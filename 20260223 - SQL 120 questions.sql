...
select sin(30*(3.14/180)) sin_value;

-- 2. Find cosine value of an angle.
select cos(30*(3.14/180)) cos_value;

-- 3. Find tangent value.
select TAN(30*(3.14/180)) tan_value;

-- 4. Convert degrees to radians.
select 30*(3.14/180) degree_to_radians;

-- 5. Convert radians to degrees.
select 0.5233*(180/3.14) radians_to_degrees;
